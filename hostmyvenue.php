        ...
        <div class="container px-2">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 p-2 mb-lg-0">
                    ...
                    <!-- <li class="nav-item"><button class="btn btn-outline-success text-white" data-bs-toggle="modal" data-bs-target="#register" type="Register">Host my Venue</button></li> -->
                </ul>
            </div>
        </div>
    </nav>
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-6">
                    <div class="text-center my-5">
                        <h1 class="display-5 fw-bolder text-white mb-2"> Sign up in our website. </h1>
                        <p class="lead text-white-50 mb-4">Quickly add your available space to VenueGuru and generate some passive income.</p>
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
                        <button class="btn btn-success text-white" data-bs-toggle="modal" data-bs-target="#register" type="Register">Register myself</button>
